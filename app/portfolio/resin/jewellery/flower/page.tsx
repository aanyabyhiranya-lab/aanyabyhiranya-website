...
export const metadata: Metadata = {
  ...
  description: "Pressed flowers preserved in resin: rings, pendants, earrings, and more. Each piece holds a real bloom, forever.",
};
...
async function getArtworks() {
  try {
    ...
    const { data } = await supabase.from("artworks").select("*")
      .eq("category", "Resin / Jewellery / Flower").order("created_at", { ascending: false });
    return data || [];
  } catch { return []; }
}
